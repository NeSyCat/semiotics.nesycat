 ...
 * convention documented in concept/03-orm-schema/codegen/README.md) and emit a Drizzle schema.ts.
 *
 * Usage: tsx concept/03-orm-schema/codegen/diagram-to-drizzle.ts <input.json> <output.ts>
 *
...
function main(): void {
  ...
  if (!inPath || !outPath) die('usage: tsx concept/03-orm-schema/codegen/diagram-to-drizzle.ts <input.json> <output.ts>')
  ...
  parts.push(
    `// DO NOT EDIT — generated by concept/03-orm-schema/codegen/diagram-to-drizzle.ts from ${relIn}.`,
